...
# your code here #
##################
deep_walk_model = deepwalk(G, n_walks, walk_length, n_dim)
...
def visualize(model, n, dim):
    ...
    nodes = deep_walk_model.wv.index2entity[:n]
    ...
    plt.save("web_embedding.png")
    plt.show()


visualize(deep_walk_model, 100, n_dim)